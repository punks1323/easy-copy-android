 ...
 */
@Singleton
@Component(modules = [AndroidInjectionModule::class, ApplicationModule::class, RetrofitModule::class, CoreManagerModule::class, DataProviderModule::class, ActivityBuilder::class])
interface ApplicationComponent {
    ...
    fun inject(app: EasyCopyApplication)
}